...
if __name__ == '__main__':
    for func in [
        test_non_threaded_empty_dir, test_non_threaded_dirname,
        test_non_threaded_one_empty_file, test_non_threaded_five, test_threaded_empty_dir,
        test_threaded_dirname, test_threaded_one_empty_file, test_threaded_five
    ]:
        try:
            os.mkdir('temp')
            func(Path('temp'))
